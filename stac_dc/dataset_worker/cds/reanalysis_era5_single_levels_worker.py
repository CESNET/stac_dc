...
class ReanalysisERA5SingleLevelsWorker(ERA5Worker):
    def __init__(
        ...
        self._variables = [
            ...
            'boundary_layer_height', 'charnock', 'clear_sky_direct_solar_radiation_at_surface',
            'cloud_base_height', 'coefficient_of_drag_with_waves', 'convective_available_potential_energy',
            'convective_inhibition', 'convective_precipitation', 'convective_rain_rate', 'convective_snowfall',
            ...
            'forecast_surface_roughness', 'free_convective_velocity_over_the_oceans', 'friction_velocity',
            ...
            'k_index', 'lake_bottom_temperature', 'lake_cover', 'lake_depth', 'lake_ice_depth',
            'lake_ice_temperature', 'lake_mix_layer_depth', 'lake_mix_layer_temperature', 'lake_shape_factor',
            ...
            'mean_eastward_gravity_wave_surface_stress', 'mean_eastward_turbulent_surface_stress',
            ...
            'mean_runoff_rate', 'mean_sea_level_pressure', 'mean_snow_evaporation_rate', 'mean_snowfall_rate',
            ...
            'mean_top_downward_short_wave_radiation_flux', 'mean_top_net_long_wave_radiation_flux',
            ...
            'precipitation_type', 'runoff', 'sea_ice_cover', 'sea_surface_temperature',
            ...
            'slope_of_sub_gridscale_orography', 'snow_albedo', 'snow_density', 'snow_depth', 'snow_evaporation',
            'snowfall', 'snowmelt', 'soil_temperature_level_1', 'soil_temperature_level_2',
            ...
            'top_net_thermal_radiation_clear_sky', 'total_cloud_cover', 'total_column_cloud_ice_water',
            'total_column_cloud_liquid_water', 'total_column_ozone', 'total_column_rain_water',
            ...
            'wave_spectral_directional_width_for_wind_waves', 'wave_spectral_kurtosis',
